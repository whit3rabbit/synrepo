...
pub struct HybridSearchRow {
    ...
    /// Discovery-root kind when known.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub root_kind: Option<String>,
    /// Human-readable root label when known.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub root_label: Option<String>,
    /// Full Git ref for branch snapshot roots when known.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub root_ref: Option<String>,
    /// Commit object id for branch snapshot roots when known.
    #[serde(skip_serializing_if = "Option::is_none")]
