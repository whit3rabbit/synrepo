...
fn collect_tool_outputs(
    ...
    vec![
        ...
        cards::handle_minimum_context(state, file_path.to_string(), "normal".to_string(), None),
        cards::handle_call_path(state, symbol_target.clone(), "tiny".to_string(), None),
        cards::handle_test_surface(state, "src".to_string(), "tiny".to_string(), None),
        cards::handle_change_risk(state, file_path.to_string(), "tiny".to_string(), None),
