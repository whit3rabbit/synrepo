...
Route bindings are parser-observed graph facts where supported. Rust Axum/Actix/Rocket and TypeScript/JavaScript Express-style routes emit `route` symbols and `References` edges to resolved handlers.
