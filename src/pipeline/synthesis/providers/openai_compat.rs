...
use crate::pipeline::synthesis::cross_link::CandidatePair;
...
impl OpenAiCompatProvider {
    ...
    fn resolve_response_usage(
        ...
        crate::pipeline::synthesis::telemetry::TokenUsage,
        Option<f64>,
    ) {
...
impl CrossLinkGenerator for OpenAiCompatProvider {
    fn generate_candidates(
        &self,
        scope: &crate::pipeline::synthesis::cross_link::CandidateScope,
