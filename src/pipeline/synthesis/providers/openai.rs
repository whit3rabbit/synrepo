...
/// Default OpenAI model for synthesis (gpt-4o-mini is cheap and reliable).
pub const DEFAULT_MODEL: &str = "gpt-4o-mini";

const API_URL: &str = "https://api.openai.com/v1/chat/completions";
const PASS_ID: &str = "commentary-v1-openai";
const CROSS_LINK_PASS_ID: &str = "cross-link-v1-openai";

/// OpenAI-backed commentary generator.
pub struct OpenAiCommentaryGenerator {
    api_key: String,
    model: String,
...
impl OpenAiCommentaryGenerator {
...
impl CommentaryGenerator for OpenAiCommentaryGenerator {
    fn generate(&self, node: NodeId, context: &str) -> crate::Result<Option<CommentaryEntry>> {
        ...
        // OpenAI uses messages array with system role for the system prompt
...
pub struct OpenAiCrossLinkGenerator {
    api_key: String,
    model: String,
    max_tokens_per_call: u32,
...
impl CrossLinkGenerator for OpenAiCrossLinkGenerator {
...
mod tests {
    ...
    fn new_constructs_without_panicking() {
        let gen =
            OpenAiCommentaryGenerator::new("fake-key".to_string(), "test-model".to_string(), 5000);
