## Purpose
Define machine-authored commentary storage, provenance, freshness, retrieval boundaries, and audit exposure without allowing overlay content to override graph truth.
