## Purpose
Define how LLM-authored commentary is persisted, retrieved, and kept synchronized with the canonical graph. Commentary is the first overlay content type; this spec governs its storage, provenance, freshness derivation, and pruning guarantees.
